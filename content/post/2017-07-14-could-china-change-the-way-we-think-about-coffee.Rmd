...
tags: []
draft: true
summaryText: <p>China might not be the first country you think of when it comes to coffee, but its influence is growing. It might not come as a surprise that as China develops it’s drinking more coffee, you might not expect it to be one of the world’s major producers. While data can be hard to come by, it seems that China has been investing significantly in the coffee sector, and could soon be a major player.</p>
---
...
map2 %>% 
    ...
    addLegend(
        ...
        title = "Starbucks stores worldwide, grouped by city (China in red)")
```
